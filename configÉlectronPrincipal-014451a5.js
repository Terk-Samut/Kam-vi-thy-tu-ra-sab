import{w as U}from"./index-55711e8e.js";import{w as F,A as z}from"./const-221e0122.js";import{w as H}from"./index-c9b234c6.js";import{w as K}from"./index-a75f989b.js";import{z as V,aq as X,g as Y,ar as _,m as C,a6 as S,as as T,r as Z,k as ee}from"./index-f7afb7b1.js";var I={exports:{}},W={exports:{}},x={};const B="/home/runner/work/Kam-vi-thy-tu-ra-sab/Kam-vi-thy-tu-ra-sab/node_modules/electron",te=V(X),E=Y,$=te,k=$.join(B,"path.txt");function ne(){let l;if(E.existsSync(k)&&(l=E.readFileSync(k,"utf-8")),{}.ELECTRON_OVERRIDE_DIST_PATH)return $.join({}.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(B,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var J=ne(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ie=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
...
//# sourceMappingURL=configÉlectronPrincipal-014451a5.js.map
