import{w as G}from"./index-a861b7b2.js";import{w as F,A as H}from"./const-17ef06f7.js";import{w as z}from"./index-2eb49411.js";import{w as K}from"./index-5cda7f43.js";import{D as V,a3 as X,a as Y,a4 as _,m as C,U as S,a5 as T,r as Z,i as ee}from"./index-9f6cef2c.js";var I={exports:{}},W={exports:{}},x={};const B="/home/runner/work/Kam-vi-thy-tu-ra-sab/Kam-vi-thy-tu-ra-sab/node_modules/electron",te=V(X),E=Y,$=te,k=$.join(B,"path.txt");function ne(){let l;if(E.existsSync(k)&&(l=E.readFileSync(k,"utf-8")),{}.ELECTRON_OVERRIDE_DIST_PATH)return $.join({}.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(B,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var J=ne(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ie=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
