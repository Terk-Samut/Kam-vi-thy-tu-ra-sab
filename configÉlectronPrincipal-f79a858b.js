import{w as U}from"./index-9a6d4db6.js";import{w as F,A as z}from"./const-c178da2d.js";import{w as H}from"./index-33c64a85.js";import{w as K}from"./index-10baa504.js";import{z as V,aq as X,g as Y,ar as _,m as C,a6 as S,as as T,r as Z,k as ee}from"./index-e114bcb6.js";var I={exports:{}},W={exports:{}},x={};const B="/home/runner/work/Kam-vi-thy-tu-ra-sab/Kam-vi-thy-tu-ra-sab/node_modules/electron",te=V(X),E=Y,$=te,k=$.join(B,"path.txt");function ne(){let l;if(E.existsSync(k)&&(l=E.readFileSync(k,"utf-8")),{}.ELECTRON_OVERRIDE_DIST_PATH)return $.join({}.ELECTRON_OVERRIDE_DIST_PATH,l||"electron");if(l)return $.join(B,"dist",l);throw new Error("Electron failed to install correctly, please delete node_modules/electron and try installing again")}var J=ne(),R={};Object.defineProperty(R,"__esModule",{value:!0});R.getRelayWindow=void 0;const ie=(l,n)=>`
   <!DOCTYPE html>
    <html>
      <head></head>
      <body>
  ...
  `;R.getRelayWindow=ie;Object.defineProperty(x,"__esModule",{value:!0});const M=J,re=R,se=_,f=se("electron-webrtc-relay:ResourceManager");class oe{constructor(n,r){this.maxWindows=1,this.windowIDtoStatsMap=new Map,this.referenceToWindowMap=new Map,this.rollingCounter={i:0,length:0},this.internalWindowCounter=0,this.internalWindowQueueBuffer=0,this.opts=n,typeof this.opts.maxWindows>"u"&&(this.opts.maxWindows=1),this.maxWindows=this.opts.maxWindows,this.opts.debug&&(f.enabled=!0),this.registerListener(),this.openWindow(r)}openWindow(n){if(f("trying to create window"),this.internalWindowQueueBuffer+=15,this.internalWindowCounter>=this.maxWindows)return!1;const r=this.internalWindowCounter.toString();this.internalWindowCounter++,f(`creating window: ${r}`);const a=new M.BrowserWindow({title:"WRTC Relay",width:this.opts.debug?900:0,height:this.opts.debug?750:0,transparent:!this.opts.debug,frame:this.opts.debug,alwaysOnTop:!1,skipTaskbar:!0,center:!0,show:!0,webPreferences:{nodeIntegration:typeof this.opts.preload!="string",contextIsolation:typeof this.opts.preload=="string",webSecurity:!0,preload:typeof this.opts.preload=="string"?this.opts.preload:"",devTools:!!this.opts.debug}});this.opts.debug&&a.webContents.openDevTools(),a.webContents.setWebRTCIPHandlingPolicy(typeof this.opts.webrtcPolicy=="string"?this.opts.webrtcPolicy:"default");const c="data:text/html;charset=UTF-8,"+encodeURIComponent((0,re.getRelayWindow)(typeof this.opts.preload=="string",typeof this.opts.debug<"u"&&this.opts.debug));return a.loadURL(c),a.on("ready-to-show",()=>{a.webContents.send("WRTCRelayData",{id:"relayInit",code:`window.windowID = ${r}
      ...
      `,i=>{for(let o of i){let u=o.stats;delete o.stats,o.names=()=>Object.keys(u),o.stat=g=>u[g]}e({result:()=>i})})}_eval(e,i,o){let u,g;const y=new Promise((p,G)=>{u=p,g=G}),w=r.default.randomBytes(16).toString("hex");return c.once(w,p=>{p.err?(o&&o(p.err),g(p.err)):(i&&i(p.res),u(p.res))}),c.eval(JSON.stringify(this._id),`
        (function () {
      ...
      `,p=>{p&&h.emit("error",p,this)}),y}_callRemote(e,i,o,u){return this._eval(`pc.${e}(${i||""})`,o,u)}}},v.exports}var D,P;function ye(){return P||(P=1,D=class{constructor(n){this.type=n.type,this.sdp=n.sdp}toJSON(){return this}}),D}var O,N;function be(){return N||(N=1,O=class{constructor(n){this.candidate=n.candidate,this.sdpMid=n.sdpMid,this.sdpMLineIndex=n.sdpMLineIndex}}),O}var ve=I.exports;Object.defineProperty(ve,"__esModule",{value:!0});const me=S,Ce=fe;I.exports=function(l){const n=new Ce(l),r=new me.EventEmitter;return Object.assign(r,{close:n.close.bind(n),electronDaemon:n,init:n.init.bind(n),RTCPeerConnection:we()(n,r),RTCSessionDescription:ye(),RTCIceCandidate:be(),RTCDataChannel:j()(n,r)})};var _e=I.exports;const Se=ee(_e),Q=Se();Q.init();const q=H({wrtc:Q}),ke={libp2p:{transports:[K(),U(),q.transport,F()],peerDiscovery:[q.discovery],addresses:{listen:z}}};export{ke as default};
//# sourceMappingURL=configÉlectronPrincipal-f79a858b.js.map
