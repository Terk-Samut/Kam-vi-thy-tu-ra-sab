...
export const URL_TÉLÉCHARGEMENTS = 'https://github.com/Terk-Samut/Kam-vi-thy-tu-ra-sab/releases';
export const IPA_TÉLÉCHARGEMENTS = 'https://api.github.com/repos/Terk-Samut/Kam-vi-thy-tu-ra-sab/releases';
